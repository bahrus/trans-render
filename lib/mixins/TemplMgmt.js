...
export const TemplMgmt = (superclass) => class extends superclass {
    ...
    async cloneTemplate({ noshadow, shadowRoot, mainTemplate, mntCnt, hydratingTransform, transform }) {
        // if(mntCnt === undefined){
        //     let count = 0;
        //     if(hydratingTransform !== undefined) count++;
        //     if(transform !== undefined) count++;
        //     this.mntCnt = count;
        // }
        let root = this;
        if (!noshadow) {
