...
export class CE {
    ...
    def(args) {
        ...
        class newClass extends ext {
            constructor() {
                super();
                _newClass_mergedActions.set(this, void 0);
                this.attachQR();
            }
            get mergedActions() {
                if (__classPrivateFieldGet(this, _newClass_mergedActions, "f") === undefined) {
                    __classPrivateFieldSet(this, _newClass_mergedActions, super.mergedActions || {}, "f");
                    Object.assign(__classPrivateFieldGet(this, _newClass_mergedActions, "f"), config.actions);
                }
                return __classPrivateFieldGet(this, _newClass_mergedActions, "f");
            }
            attributeChangedCallback(n, ov, nv) {
                ...
                if (this.inAbsorbMode || this.inReflectMode)
                    propName = '_' + propName;
                if (prop !== undefined) {
                    if (prop.dry && ov === nv)
                        return;
            ...
            connectedCallback(myArgs = undefined) {
        ...
        _newClass_mergedActions = new WeakMap();
        newClass.is = tagName;
