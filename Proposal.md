...
2.  Until 1 is fulfilled, use the template element as a stand-in for the meta tag as a last resort (table row groupings, seect tags).
3.  Specify some decisions for how microdata would be specified in certain scnarios.
