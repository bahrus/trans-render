...
[TODO]  This may be a bad idea once the DOM elements are added to the LIVE DOM, tree, as it may result in more page reflows.  Maybe first check if sync method is defined, if so use it, else call async one? 
