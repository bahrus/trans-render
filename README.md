...
I think this alternative approach can provide value, in that the binding rules are data elements.  A web component can be based one main template, which references other satellite templates.  It can then define a base binding, which extending web components or even end consumers can then extend and/or override.
