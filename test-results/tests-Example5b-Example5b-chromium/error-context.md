...
- Name: Example5b
- Location: C:\git\trans-render\tests\Example5b.spec.mjs:3:1
...
Call log:
  ...
  - waiting for locator('#target')
    ...
    at C:\git\trans-render\tests\Example5b.spec.mjs:8:24
```
...
```ts
  ...
  2 |
  3 | test('Example5b', async ({ page }) => {
  4 |   await page.goto('./tests/Example5b.html');
  5 |   // wait for 1 second
